...
*********************************************************************************************************************************************************** -->
            ...
            <div class="form-horizontal style-form" method="get">
              <div class="form-panel">
                <div class="form-group">
                  <br>
                  <div class="col-sm-10">
                    <label>Texto para compartir en sus redes sociales, cuando compartes un reporte
                    </label>
                    <textarea placeholder="Configura tu texto a compartir" rows="4" cols="50"  class="form-control" name="MyTextArea" id="MyTextArea" ><?php if (!empty($_COOKIE["configura"])){echo htmlspecialchars($_COOKIE["configura"]);}?></textarea>
                    <br>
                    <button type="button" class="btn btn-primary btn-lg" onclick="setCookie()" >Guardar
                    </button>	
    ...
    <footer class="site-footer" style="display:none;">
      <div class="text-center">
        ...
        <a href="configuracion.php#" class="go-top">
  ...
  <script type="application/javascript">
    function setCookie(cname,cvalue,exdays) {
      var d = new Date();
      exdays=5;
      cvalue=document.getElementById("MyTextArea").value;
      cname="configura";
